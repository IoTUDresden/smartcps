 ...
 * 
 */
public class HumanTaskChooserStickyGridHeadersAdapterWrapper extends BaseAdapter implements StickyGridHeadersBaseAdapter {
	private HumanTaskChooserListAdapter mDelegate;
	 ...
	 */
	public HumanTaskChooserStickyGridHeadersAdapterWrapper(HumanTaskChooserListAdapter adapter) {
		mDelegate = adapter;
