 ...
 * 
 * @see <a
 *      href="http://stackoverflow.com/questions/5033012/auto-scale-textview-text-to-fit-within-bounds">stackoverflow</a>
 * 
...
public class AutoResizeTextView extends TextView {
	 ...
	 * 
	 * @return the upper text size limit
	 */
	 ...
	 * 
	 * @return the lower text size limit
	 */
	...
	public void resizeText(int width, int height) {
		...
		if (mAddEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
			...
			StaticLayout layout = new StaticLayout(text, textPaint, width, Layout.Alignment.ALIGN_NORMAL, mSpacingMult,
					mSpacingAdd, false);
	...
	private int getTextWidth(CharSequence source, TextPaint paint, float textSize) {
		...
		return (int) paint.measureText(source, 0, source.length()) + getPaddingLeft() + getPaddingRight();
	}
